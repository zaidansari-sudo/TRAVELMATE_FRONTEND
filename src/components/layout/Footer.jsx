  ...
  return (
    <footer className="relative bg-white text-emerald-900 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-40">
        <div className="absolute top-0 right-0 w-72 sm:w-96 h-72 sm:h-96 bg-emerald-100 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-20 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-start mb-12">
          ...
          <div className="lg:col-span-5 space-y-6 text-center lg:text-left">
            <div>
              <a href="/" className="inline-block group">
                <h2 className="text-3xl sm:text-4xl font-serif text-emerald-900 tracking-wide mb-2 group-hover:text-emerald-700 transition-colors font-bold">
                  TRAVELMATE
                </h2>
            ...
            <p className="text-sm sm:text-base leading-relaxed text-gray-700 max-w-md mx-auto lg:mx-0 font-semibold">
              Thoughtfully crafted journeys across India's hidden landscapes,
          ...
          {/* Links Section */}
          <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 gap-10 text-center sm:text-left">
            <div>
              <h4 className="text-lg sm:text-xl uppercase tracking-[0.35em] text-emerald-900 font-bold mb-5 flex items-center gap-2 justify-center sm:justify-start">
          ...
          <div className="lg:col-span-3 text-center sm:text-left lg:text-right">
            <h4 className="text-lg sm:text-xl uppercase tracking-[0.35em] text-emerald-900 font-bold mb-5 flex items-center gap-2 justify-center sm:justify-start lg:justify-end">
              <div className="w-8 h-px bg-emerald-600" />
              Contact
            </h4>
